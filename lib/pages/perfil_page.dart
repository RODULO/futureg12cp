...
class _PerfilPageState extends State<PerfilPage> {
 ...
 //agregado
  Future<List<NotableWorkModel>> getNotableWorks() async {
    return Future.delayed(Duration(seconds: 4), () {
      return [
        NotableWorkModel(
          category: "Nature",
        ...
        NotableWorkModel(
          category: "Travel",
          title: "These are the top places in world to visit",
          imageUrl:
              "https://images.pexels.com/photos/346529/pexels-photo-346529.jpeg",
        ),
        NotableWorkModel(
          category: "Architecture",
          title: "This is modern architecture of 2025",
          imageUrl:
        ...
        NotableWorkModel(
          ...
          imageUrl:
              "https://images.pexels.com/photos/35550/brain-mind-psychology-thinking.jpg",
        ),
      ];
    });
  }
//hasta aqui
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        body:
            pesonaPerfil == null || notableWorks.isEmpty
